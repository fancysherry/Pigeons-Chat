...
cd /xx/work/server0/
nohup java -jar  cim-server-1.0.0-SNAPSHOT.jar --cim.server.port=9000 --app.zk.addr=127.0.0.1  > log-server.file 2>&1 &
```
...
cd /xx/work/route0/
nohup java -jar  cim-forward-route-1.0.0-SNAPSHOT.jar --app.zk.addr=127.0.0.1 --spring.redis.host=127.0.0.1 --spring.redis.port=6379  > log-route.file 2>&1 &
```
...
cd /xx/work/route0/
java -jar cim-client-1.0.0-SNAPSHOT.jar --server.port=8084 --cim.user.id=123 --cim.user.userName=123 --cim.group.route.request.url=http://127.0.0.1:8083/groupRoute --cim.server.route.request.url=http://127.0.0.1:8083/login
```
